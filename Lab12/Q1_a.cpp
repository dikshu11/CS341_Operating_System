...
int FCFS(int head,int* work_queue, int work_queue_size, int cnt_cylinder, int seek_rate){
...
int main()
{
  ...
  cout << "FCFS disk Scheduling Algorithm: " << endl << endl;
  cout << "Request Processed Order :" << endl;
  int scan = FCFS(head,work_queue, work_queue_size, cnt_cylinder, seek_rate);
}